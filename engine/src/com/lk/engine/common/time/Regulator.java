...
public class Regulator {
	...
	private static final double UPDATE_PERIOD_VARIATOR = 10.0; // TODO:
																														 // configurable?
	...
	public Regulator(RandomGenerator random, final double numUpdatesPerSecondRqd) {
		this.random = random;
	...
	public boolean isReady() {
		...
		if (currentTime >= nextUpdateTime) {
			nextUpdateTime = (long) (currentTime + updatePeriod + random.randInRange(-UPDATE_PERIOD_VARIATOR,
