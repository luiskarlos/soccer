...
import static com.lk.engine.soccer.console.ParamNames.BALL;
import static com.lk.engine.soccer.console.ParamNames.BLUE_GOALKEEPER;
import static com.lk.engine.soccer.console.ParamNames.BLUE_PLAYER;
import static com.lk.engine.soccer.console.ParamNames.GOAL;
import static com.lk.engine.soccer.console.ParamNames.RED_GOALKEEPER;
import static com.lk.engine.soccer.console.ParamNames.RED_PLAYER;
...
import static com.lk.engine.soccer.console.ParamNames.TEAM;
...
public class ParamAccessBuilder {
	...
	private List<ParamHandler> fieldPlayer(final String name, final PlayerParams params) {
		...
		accessors.add(new ParamHandler(name + ".keeperInBallRange", params, new ParamAccess() {
			@Override
			public void setValue(final String val) {
				params.setKeeperInBallRange(parseDouble(val));
			}

			@Override
			public String getValue() {
				return format(params.getKeeperInBallRange());
			}
		}));
