...
public class PlayerParams extends MovingEntityParams {
	...
	private double comfortZone = 60.0;
	...
	private double keeperInBallRange = 10.0;
	private double playerInTargetRange = 10.0;

	private double chanceAttemptsPotShot = 0.005;

	private double minPassDistance = 120.0;

	private double chanceOfUsingArriveTypeReceiveBehavior = 0.5;
	...
	public double getKeeperInBallRange() {
		return keeperInBallRange;
	}

	public double getKeeperInBallRangeSq() {
		return keeperInBallRange * keeperInBallRange;
	}

	public void setKeeperInBallRange(double keeperInBallRange) {
		this.keeperInBallRange = keeperInBallRange;
	}
